...
AND Seasons_i.SeasonID = z_player_season_matches.SeasonID
GROUP BY players.player_name, z_player_season_matches.Mat, Seasons_i.Year, Seasons_i.Eleven, Seasons_i.Association, Seasons_i.Grade
ORDER BY Runs DESC;
